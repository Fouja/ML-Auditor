#!/usr/bin/env python3
"""JobChameleon — one-command local startup.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Set up and launch JobChameleon locally.")
    ...
    print(_c("JobChameleon local startup", "1"))
    print(f"  repo: {ROOT}")
